(ns pasta-xiana.core
  (:require
    [pasta-xiana.controllers.index :as index]
    [pasta-xiana.controllers.re-frame :as re-frame]
    ...
    [pasta-xiana.penkala :as penkala]
    [pasta-xiana.funicular :as api]
    [pasta-xiana.readers :refer [readers]]
    [pasta-xiana.handlers.funicular]
    [state :as st]
