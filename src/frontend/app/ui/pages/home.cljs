    ...
    (d/div {:class "max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8"}
      ...
      (d/div {:class "mt-8 flex justify-center"}
        (d/div {:class "inline-flex rounded-md shadow"}
          (d/a {:class "inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700"
