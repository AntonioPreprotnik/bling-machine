(ns backend.funicular
  (:require
   [backend.readers :refer [readers]]
   [clojure.edn :as edn]
   [clojure.java.io :as io]
   [clojure.spec.alpha :as s]
   [com.verybigthings.funicular.core :as funicular]
   [shared.schema :refer [registry]]))
...
(defn init [config]
  (let [funicular-cnf (edn/read-string {:readers readers :config config} (slurp (io/resource "shared/funicular.edn")))
