(defproject app "0.1.0-SNAPSHOT"
  ...
  :profiles {:uberjar   {:aot      :all
             ...
             :dev       {:main         user
                         :source-paths ["dev" "config/dev" "utils"]
                         :dependencies [;; VBT
             ...
             :test      {:source-paths ["config/test" "utils"]
                         :dependencies [;; VBT
  ...
  :aliases {"ci"               ["do" "clean," "kondo-lint," "uberjar"]
            "runner"           ["run" "-m" "cognitect.test-runner"
                                "run" "-d" "test"]
            "kaocha"           ["with-profile" "+kaocha,+test" "run" "-m" "kaocha.runner"]
            "kondo-lint"       ["clj-kondo" "--lint" "src" "test"]
            "lint"             ["do" "kondo-lint," "eastwood," "kibit"]
